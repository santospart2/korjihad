...
<head>
  ...
  <title><?= $title ?></title>
  <link rel="stylesheet" href="<?= a('css/swiper-bundle.min.css') ?>" />
  <link rel="stylesheet" href="<?= a('swiper/style.css') ?>">
  <link rel="stylesheet" href="<?= a('css/bootstrap.min.css') ?>">
  <link rel="stylesheet" type="text/css" href="<?= a('css/navmenu.css') ?>">
  <!-- <script type="text/javascript" src="<?= a('js/ionicons.esm.js') ?>"></script> -->
  <!-- <script type="text/javascript" src="<?= a('js/ionicons.js') ?>"></script> -->
...
<img src="<?= site_url('assets/img/logo.png') ?>" style="height: 100px; ">
...
<script src="<?= a('js/swiper-bundle.min.js') ?>"></script>
