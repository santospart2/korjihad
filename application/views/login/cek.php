            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4"><a href="<?= site_url('/') ?>" >
                  <img src="<?= site_url('assets/img/logo.png') ?>" style="height: 100px;" alt="">
                  <span class="d-none d-lg-block">Korjihad</span>
                </a></h5>
                  ...
                  <div class="col-12">
                    <button class="btn btn-primary w-100" type="submit">Berikutnya</button>
                  </div>
                <?= form_close(); ?>
              </div>
            </div>
...
<script src="<?= site_url('assets/vendor/chart.js/chart.umd.js') ?>"></script>
